...
<html>
    <head>
        ...
        <!-- <link href="https://cdn.tailwindcss.com/2.2.7/tailwind.min.css" rel="stylesheet"> -->
    ...
    <div class="container px-5 py-24 mx-auto flex">
      <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
        <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">お問い合せフォーム</h2>
        <p class="leading-relaxed mb-5 text-gray-600">以下のフォームからお問い合わせください。</p>
      ...
      <!-- お問い合せ内容 -->
       <div class="relative mb-4">
        <label for="content" class="leading-7 text-sm text-gray-600">お問い合せ内容</label>
        <textarea id="message" name="content" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
      </div>
